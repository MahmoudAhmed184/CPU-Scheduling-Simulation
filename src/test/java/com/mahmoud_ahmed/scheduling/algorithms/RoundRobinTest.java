...
public class RoundRobinTest {
    ...
    void whenSchedulingProcessesWithVariousQuanta_shouldBehaveCorrectly(int quantum, String testCase, List<Process> input, List<ExecutionSegment> expected) {
        roundRobin = new RoundRobin(quantum); // Use dynamic quantum value
        List<ExecutionSegment> result = roundRobin.schedule(input);
